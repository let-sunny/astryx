import{ai as i,a2 as e,a7 as z,ag as T,az as D,a8 as A,aL as q,ak as F,T as w}from"./iframe-BGOI6B5l.js";import{u as G}from"./useListFocus-CuqszsNM.js";import{u as L}from"./useTypeahead-Bd1kjEDk.js";import{u as P,a as V,b as W,F as O}from"./ChartBarIcon-Bhbub1Rm.js";import{F as E}from"./UserIcon-1XRJM6NT.js";import{F as R}from"./Cog6ToothIcon-B0BdPx71.js";import{F as K}from"./DocumentTextIcon-DY0VqPSM.js";import{F as _}from"./ShieldCheckIcon-BGCOFndm.js";import"./preload-helper-Ct5FWWRu.js";const U={root:{k1xSpc:"astryx78zum5",kXwgrk:"astryxdt5ytf",kOIVth:"astryx1lsbc85",$$css:!0}},B={sm:{k7Eaqz:"astryx5w4yej",$$css:!0},md:{k7Eaqz:"astryx1jzhcrs",$$css:!0},lg:{k7Eaqz:"astryxlm99nl",$$css:!0}};function I({ref:s,children:o,size:t="md",minWidth:l,xstyle:u,className:p,style:r,"data-testid":M}){const m=P()?.closeMenu,{listRef:d,handleKeyDown:c,focusItem:g}=G({itemSelector:'[role="menuitem"]:not([aria-disabled="true"])',onEscape:m}),f=i.useCallback(()=>d.current?Array.from(d.current.querySelectorAll('[role="menuitem"]:not([aria-disabled="true"])')):[],[d]),h=L({getItemLabels:()=>f().map(a=>a.textContent),onMatch:g,getCurrentIndex:()=>f().findIndex(a=>a===document.activeElement||a.contains(document.activeElement))}),N=i.useCallback(a=>{if(a.key==="Enter"||a.key===" "){const S=document.activeElement;if(S?.getAttribute("role")==="menuitem"){a.preventDefault(),S.click();return}}if(h.onKeyDown(a)){a.preventDefault();return}c(a)},[c,h]),C=i.useMemo(()=>({closeMenu:m??(()=>{}),size:t}),[m,t]),$=l!=null?{...r,minWidth:l}:r;return e.jsx(V,{value:C,children:e.jsx("div",{ref:A(s,d),role:"menu",onKeyDown:N,"data-testid":M,...z(D("nav-heading-menu",{size:t}),T(U.root,B[t],u),p,$),children:o})})}I.displayName="NavHeadingMenu";I.__docgenInfo={description:`Accessible menu container for nav heading popovers.
