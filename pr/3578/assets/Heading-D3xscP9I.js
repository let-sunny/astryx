const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./iframe-BGOI6B5l.js","./preload-helper-Ct5FWWRu.js","./iframe-CBjjxB66.css"])))=>i.map(i=>d[i]);
import{_ as P}from"./preload-helper-Ct5FWWRu.js";import{aQ as V,ai as s,a2 as n,a7 as z,ag as v,az as E,a8 as W,C as B,v as C,a3 as D,ay as N,aR as A,aB as f,J as F,F as U,ao as I,an as O,x as $,aC as J}from"./iframe-BGOI6B5l.js";const Q=s.lazy(async()=>P(()=>import("./iframe-BGOI6B5l.js").then(a=>a.j),__vite__mapDeps([0,1,2]),import.meta.url).then(a=>({default:a.Tooltip}))),X={1:"h1",2:"h2",3:"h3",4:"h4",5:"h5",6:"h6"};function y({level:a,type:l,accessibilityLevel:i,color:o="primary",display:h="block",maxLines:e=0,hasTruncateTooltip:r=!0,wordBreak:g,textWrap:d,justify:u="start",hasCapsize:m=!1,hasStrikethrough:b=!1,xstyle:H,className:T,style:w,children:k,ref:S,...x}){const R=X[a],q=i&&i!==a?{"aria-level":i}:{},L=g??(e===1?"break-all":"break-word"),_=e>0||m?"block":h,t=V({maxLines:e}),j=typeof r=="string"?r:"above",c=e>0&&r!==!1&&t.isTruncated,p=s.useRef(null),M=e>1?{WebkitLineClamp:e}:void 0;return n.jsxs(n.Fragment,{children:[n.jsx(R,{ref:W(S,t.ref,p),...z(E("heading",{level:a,color:o,...l&&{type:l}}),v($[o],l?I[l]:O[a],l&&U[l],e===1?f.singleLine:e>1?f.multiLine:F[_],e>0&&A[L],d&&N[d],u!=="start"&&D[u],m&&C.enabled,b&&B.strikethrough,H),T,{...w,...M}),title:c?t.fullText:void 0,...q,...x,children:k}),c&&n.jsx(s.Suspense,{fallback:null,children:n.jsx(Q,{anchorRef:p,content:n.jsx("span",{...v(J.content),children:t.fullText}),placement:j})})]})}y.displayName="Heading";y.__docgenInfo={description:`Heading - Semantic heading component
