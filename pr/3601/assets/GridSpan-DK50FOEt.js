import{a0 as d,a5 as m,ae as u,ax as c}from"./iframe-BwQlusDS.js";const y={span:{k7Eaqz:"astryxeuugli",k1xSpc:"astryxrvj5dj",kZKoxP:"astryx5yr21d",$$css:!0}};function r({columns:e,rows:n,xstyle:s,className:t,style:a,children:o,ref:i,...l}){const p={...e!=null&&{gridColumn:e==="full"?"1 / -1":`span ${e}`},...n!=null&&{gridRow:`span ${n}`}};return d.jsx("div",{ref:i,...m(c("grid-span"),u(y.span,s),t,{...a,...p}),...l,children:o})}r.displayName="GridSpan";r.__docgenInfo={description:`Grid span component for controlling how many columns/rows a grid item spans.
