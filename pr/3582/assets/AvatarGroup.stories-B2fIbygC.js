import{ai as D,a2 as r,a7 as C,ag as N,az as T}from"./iframe-BGOI6B5l.js";import{a as M,r as _,u as I,A as t}from"./Avatar-DWHyoqeo.js";import{S as $}from"./StatusDot-CgknuFxN.js";import"./preload-helper-Ct5FWWRu.js";const q=.25,W={root:{k1xSpc:"astryx3nfvp2",kGNEyG:"astryx6s0dn4",$$css:!0}};function s({children:e,size:a="small","data-testid":i,"aria-label":E="Avatars",xstyle:G,className:b,style:z,ref:j,...O}){const c=_(a),m=Math.round(c*q),R=D.useMemo(()=>({size:a,overlap:m,numericSize:c}),[a,m,c]);return r.jsx(M,{value:R,children:r.jsx("div",{ref:j,role:"group","aria-label":E,"data-testid":i,...C(T("avatar-group",{size:a}),N(W.root,G),b,z),...O,children:e})})}s.displayName="AvatarGroup";s.__docgenInfo={description:`Stacked avatar display showing multiple avatars overlapping with an
