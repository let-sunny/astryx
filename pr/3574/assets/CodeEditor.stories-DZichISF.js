import{a0 as e,ag as m}from"./iframe-CTRsnGpC.js";import{C as d}from"./CodeEditor-DRRX612Y.js";import"./preload-helper-Ct5FWWRu.js";import"./highlightRanges-ClxihVO3.js";const x={title:"Lab/CodeEditor",component:d,tags:["autodocs"],argTypes:{language:{control:"select",options:["typescript","javascript","json","html","css","python","bash","php","hack","yaml","markdown","plaintext"]},size:{control:"select",options:["sm","md"]},hasLineNumbers:{control:"boolean"},isReadOnly:{control:"boolean"}}},g=`function greet(name: string): string {
