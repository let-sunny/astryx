import{ai as s,aP as _,a2 as d,a7 as z,az as B}from"./iframe-BGOI6B5l.js";import{F}from"./Field-2-c6VEN5.js";import{L as U}from"./List-vkpT8fGP.js";import{a as W,C as X}from"./CheckboxInput-Dw5mzJOs.js";import{L as Y,a as $}from"./ListItem-CQfJB5-j.js";const G=[];function P({label:c,isLabelHidden:t=!1,description:u,status:n,value:y,onChange:g,changeAction:a,density:v="balanced",hasDividers:L=!1,isDisabled:o=!1,disabledMessage:x,isReadOnly:k=!1,children:T,ref:e,width:D,xstyle:R,className:I,style:l,"data-testid":r}){const m=s.useId(),i=s.useId(),C=s.useId(),p=s.useId(),[,w]=s.useTransition(),h=y!==void 0,j=y??G,[E,M]=s.useOptimistic(j),[S,V]=s.useOptimistic(null),f=o&&!!x,q=_({placement:"above",focusTrigger:"always",isEnabled:f}),A=s.useCallback((b,N)=>{g?.(b),a&&w(async()=>{M(b),N!==void 0&&V(N),await a(b)})},[g,a,w,M,V]),H=s.useMemo(()=>({value:h?E:void 0,onChange:h?A:void 0,isDisabled:o,hasDisabledMessage:f,isReadOnly:k,loadingValue:S}),[h,E,A,o,f,k,S]);return d.jsxs(F,{ref:e,"data-testid":r,label:c,isLabelHidden:t,description:u,inputID:m,labelID:i,isGroupLabel:!0,descriptionID:u?C:void 0,isDisabled:o,status:n?{type:n.type,message:n.message,messageID:n.message?p:void 0}:void 0,statusVariant:"detached",width:D,xstyle:R,...z(B("checkbox-list"),{className:I,style:l}),children:[d.jsx(W,{value:H,children:d.jsx("div",{ref:b=>{q.ref(b)},role:"group","aria-labelledby":i,"aria-describedby":[u?C:null,n?.message?p:null,f?q.describedBy:null].filter(Boolean).join(" ")||void 0,children:d.jsx(U,{density:v,hasDividers:L,children:T})})}),f&&q.renderTooltip(x)]})}P.displayName="CheckboxList";P.__docgenInfo={description:`A checkbox group component for multi-value selection.
...
Ignored when inside CheckboxList.`},ref:{required:!1,tsType:{name:"ReactRef",raw:"React.Ref<HTMLLIElement>",elements:[{name:"HTMLLIElement"}]},description:"Ref forwarded to the root element"}},composes:["Omit"]};export{P as C,O as a};
