import{ai as s,aP as Ce,a2 as a,a8 as Ie,a7 as De,ag as Me,az as Te,e as te,I as J}from"./iframe-BGOI6B5l.js";import{F as We}from"./Field-2-c6VEN5.js";import{I as qe}from"./InputClearButton-C3Siaaqf.js";import{u as Ue}from"./useAnnounce-B4GAFcNt.js";import"./preload-helper-Ct5FWWRu.js";import"./FieldStatus-D5bkPgvD.js";function Ae(e){return e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/(1024*1024)).toFixed(1)} MB`}function Pe(e,r,t,u,h){const m=[];let i=e;if(r){const y=r.split(",").map(c=>c.trim().toLowerCase());i=i.filter(c=>{const n=y.some(g=>g.startsWith(".")?c.name.toLowerCase().endsWith(g):g.endsWith("/*")?c.type.startsWith(g.slice(0,-1)):c.type.toLowerCase()===g);return n||m.push(`"${c.name}" is not an accepted file type`),n})}return t!=null&&(i=i.filter(y=>y.size>t?(m.push(`"${y.name}" exceeds ${Ae(t)} limit`),!1):!0)),h&&u!=null&&i.length>u&&(m.push(`Maximum ${u} files allowed`),i=i.slice(0,u)),{valid:i,errors:m}}const b={dropzone:{kB7OPa:"astryx9f619",kVAEAm:"astryx1n2onr6",kY2c9j:"astryx1vjfegm",k1xSpc:"astryx78zum5",kXwgrk:"astryxdt5ytf",kGNEyG:"astryx6s0dn4",kjj79g:"astryxl56j7k",kOIVth:"astryx1txdalj",k8WAf4:"astryxq6koh6",kg3NbH:"astryx1pzlopt",kMzoRj:"astryx1litavf",ksu8eU:"astryxbsl7fq",kVAM5u:"astryxvy26l8 astryx6q1khz",kaIpWk:"astryxh6dtrn",kWkggS:"astryx10xzikg",k1ekBW:"astryx1tv3a4w",kIyJzY:"astryxuedmi6 astryx12w9bfk",kAMwcw:"astryxlr8y92",kkrTdU:"astryx1ypdohk",kI3sdo:"astryx1a2a7pz",$$css:!0},dropzoneHover:{kGVxlE:"astryxw6ruzt",$$css:!0},dropzoneActive:{kVAM5u:"astryxad5do",kWkggS:"astryxgcxg3y",$$css:!0},dropzoneDisabled:{kkrTdU:"astryx1h6gzvc",kSiTet:"astryxbyyjgo",kVAM5u:"astryxvy26l8",$$css:!0},compact:{kB7OPa:"astryx9f619",kVAEAm:"astryx1n2onr6",kY2c9j:"astryx1vjfegm",k1xSpc:"astryx78zum5",kGNEyG:"astryx6s0dn4",kOIVth:"astryx1txdalj",k8WAf4:"astryxu0wf1k",kg3NbH:"astryxf314gf",kMzoRj:"astryx1litavf",ksu8eU:"astryx1y0btm7",kVAM5u:"astryxvy26l8 astryx6q1khz",kaIpWk:"astryxh6dtrn",kWkggS:"astryx10xzikg",k1ekBW:"astryx12zzom9",kIyJzY:"astryxuedmi6 astryx12w9bfk",kAMwcw:"astryxlr8y92",kGVxlE:"astryx1gnnqk1 astryx70dsy8",kkrTdU:"astryx1ypdohk",kZKoxP:"astryx1ueg155",kI3sdo:"astryx1a2a7pz",$$css:!0},compactDisabled:{kkrTdU:"astryx1h6gzvc",kSiTet:"astryxbyyjgo",kVAM5u:"astryxvy26l8",$$css:!0}},Re={warning:{kVAM5u:"astryx8wg1ba",kzOINU:null,kGJrpR:null,kaZRDh:null,kBCPoo:null,k26BEO:null,k5QoK5:null,kLZC3w:null,kL6WhQ:null,$$css:!0},error:{kVAM5u:"astryx1ofxpqo",kzOINU:null,kGJrpR:null,kaZRDh:null,kBCPoo:null,k26BEO:null,k5QoK5:null,kLZC3w:null,kL6WhQ:null,$$css:!0},success:{kVAM5u:"astryx16m2moy",kzOINU:null,kGJrpR:null,kaZRDh:null,kBCPoo:null,k26BEO:null,k5QoK5:null,kLZC3w:null,kL6WhQ:null,$$css:!0}};function o({label:e,isLabelHidden:r=!1,value:t,onChange:u,changeAction:h,accept:m,isMultiple:i=!1,maxSize:y,maxFiles:c,isDisabled:n=!1,disabledMessage:g,isRequired:K=!1,isLoading:w=!1,status:se,description:$,placeholder:re,mode:x="input",isOptional:le=!1,labelTooltip:ne,width:oe,xstyle:ie,className:ue,style:de,ref:ce,...pe}){const Z=s.useId(),Q=s.useId(),Y=s.useId(),me=s.useId(),f=s.useRef(null),[_,V]=s.useState(!1),[E,O]=s.useState(null),[,X]=s.useTransition(),ee=Ue(),k=n&&!!g,N=Ce({placement:"above",focusTrigger:"always",isEnabled:k}),d=se??(E?{type:"error",message:E}:void 0),ye={warning:"warning",error:"error",success:"success"},ge={warning:"warning",error:"error",success:"success"},xe=[$?Q:null,d?.message?Y:null,k?N.describedBy:null].filter(Boolean).join(" ")||void 0,L=re??(i?"Choose files":"Choose file"),z=s.useCallback(l=>{if(n)return;const{valid:p,errors:H}=Pe(l,m,y,c,i);if(H.length>0?O(H[0]):O(null),p.length===0){u(null);return}const ae=i?p:p[0];u(ae),H.length===0&&ee(p.length===1?`1 file selected: ${p[0].name}`:`${p.length} files selected`),h&&X(async()=>{await h(ae)})},[m,n,i,c,y,u,h,X,ee]),fe=s.useCallback(l=>{const p=Array.from(l.target.files??[]);z(p),f.current&&(f.current.value="")},[z]),he=s.useCallback(l=>{l.stopPropagation(),O(null),u(null),f.current&&(f.current.value="",f.current.focus())},[u]),ve=s.useCallback(()=>{n||f.current?.click()},[n]),be=s.useCallback(l=>{(l.key==="Enter"||l.key===" ")&&!n&&(l.preventDefault(),f.current?.click())},[n]),ke=s.useCallback(l=>{l.preventDefault(),l.stopPropagation(),!n&&x==="dropzone"&&V(!0)},[n,x]),Fe=s.useCallback(l=>{l.preventDefault(),l.stopPropagation(),!n&&x==="dropzone"&&V(!0)},[n,x]),we=s.useCallback(l=>{l.preventDefault(),l.stopPropagation(),V(!1)},[]),Ve=s.useCallback(l=>{if(l.preventDefault(),l.stopPropagation(),V(!1),n||x!=="dropzone")return;const p=Array.from(l.dataTransfer.files);p.length>0&&z(p)},[n,x,z]),F=t!=null&&(Array.isArray(t)?t.length>0:!0),G=F?Array.isArray(t)?t.map(l=>l.name).join(", "):t?.name??"":null,ze=()=>w?a.jsx(te,{size:"md"}):F?a.jsx("div",{className:"astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxb3r6kr astryxlyipyv astryx98rzlu astryxeuugli astryx2b8uid astryxeaf4i8",children:G}):a.jsxs(a.Fragment,{children:[a.jsx(J,{icon:"arrowUp",size:"md",color:"secondary"}),a.jsx("span",{className:"astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxv1l7n4 astryx2b8uid astryx87ps6o",children:_?"Drop files here":L})]}),je=()=>w?a.jsxs(a.Fragment,{children:[a.jsx("span",{className:"astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxb3r6kr astryxlyipyv astryxuxw1ft astryx98rzlu astryxeuugli",children:G??L}),a.jsx(te,{size:"sm"})]}):a.jsxs(a.Fragment,{children:[a.jsx(J,{icon:"arrowUp",size:"sm",color:"secondary"}),a.jsx("span",{...{0:{className:"astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxv1l7n4 astryx87ps6o astryx1yc453h astryx98rzlu astryxeuugli"},2:{className:"astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxb3r6kr astryxlyipyv astryxuxw1ft astryx1yc453h astryx98rzlu astryxeuugli"},1:{className:"astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryxv1l7n4 astryx87ps6o astryx1yc453h"},3:{className:"astryx9ynric astryxjm74w1 astryx6pjikd astryxw6l6zx astryx1tgivj0 astryxb3r6kr astryxlyipyv astryxuxw1ft astryx98rzlu astryxeuugli astryx1yc453h"}}[!!F<<1|!!F<<0],children:G??L}),d&&a.jsx(J,{icon:ye[d.type],size:"md",color:ge[d.type]})]}),v=x==="dropzone",Se=v?{onDragEnter:ke,onDragOver:Fe,onDragLeave:we,onDrop:Ve}:{};return a.jsxs(We,{label:e,isLabelHidden:r,description:$,inputID:Z,descriptionID:$?Q:void 0,isOptional:le,isRequired:K,isDisabled:n,status:d?{type:d.type,message:d.message,messageID:d.message?Y:void 0}:void 0,labelTooltip:ne,width:oe,children:[a.jsxs("div",{ref:l=>{N.ref(l)},role:"button",tabIndex:n&&!k?-1:0,"aria-disabled":k?"true":void 0,onClick:ve,onKeyDown:be,"aria-label":e,"aria-busy":w||void 0,"aria-describedby":xe,"aria-required":K?"true":void 0,"aria-invalid":d?.type==="error"?"true":void 0,...Se,...De(Te("file-input",{mode:x,status:d?.type??null}),Me(v?b.dropzone:b.compact,v&&!n&&b.dropzoneHover,v&&_&&b.dropzoneActive,v&&n&&b.dropzoneDisabled,!v&&n&&b.compactDisabled,d&&Re[d.type],ie),ue,de),children:[a.jsx("input",{...pe,ref:Ie(ce,f),id:Z,type:"file",accept:m,multiple:i,disabled:n,onChange:fe,"aria-hidden":"true",tabIndex:-1,className:"astryx10l6tqk astryx1i1rx1s astryxjm9jq1 astryx1717udv astryxkdpibf astryxb3r6kr astryxzpqnlu astryxuxw1ft astryxc342km"}),v?ze():je(),F&&!n&&!w&&a.jsx(qe,{label:`Clear ${e}`,onClick:he})]}),a.jsx("div",{id:me,role:"status","aria-live":"polite",className:"astryx10l6tqk astryx1i1rx1s astryxjm9jq1 astryx1717udv astryxkdpibf astryxb3r6kr astryxzpqnlu astryxuxw1ft astryxc342km",children:E}),k&&N.renderTooltip(g)]})}o.displayName="FileInput";o.__docgenInfo={description:'A file input component with optional drag-and-drop support.\n\n@example\n```\n<FileInput label="Resume" value={file} onChange={setFile} accept=".pdf" />\n```',methods:[],displayName:"FileInput",props:{ref:{required:!1,tsType:{name:"ReactRef",raw:"React.Ref<HTMLInputElement>",elements:[{name:"HTMLInputElement"}]},description:""},label:{required:!0,tsType:{name:"string"},description:"Accessible label for the file input."},isLabelHidden:{required:!1,tsType:{name:"boolean"},description:`Whether to visually hide the label (still accessible to screen readers).
...
}`,...B.parameters?.docs?.source}}};const Je=["Default","WithDescription","MultipleFiles","ImagesOnly","DropzoneMode","Required","Optional","Disabled","DisabledWithMessage","Loading","WithErrorStatus","WithSuccessStatus","WithTooltip","AllVariations"];export{B as AllVariations,j as Default,W as Disabled,q as DisabledWithMessage,D as DropzoneMode,I as ImagesOnly,U as Loading,C as MultipleFiles,T as Optional,M as Required,S as WithDescription,A as WithErrorStatus,P as WithSuccessStatus,R as WithTooltip,Je as __namedExportsOrder,He as default};
